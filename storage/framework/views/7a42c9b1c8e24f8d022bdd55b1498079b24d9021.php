            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <ul class="nav nav-pills">
                        <li role="presentation" class="<?php echo e(active_class( ! if_query('order', 'recent') )); ?>"><a href="<?php echo e(Request::url()); ?>?order=default">最后回复</a></li>
                        <li role="presentation" class="<?php echo e(active_class(if_query('order','recent'))); ?>"><a href="<?php echo e(Request::url()); ?>?order=recent">最新发布</a></li>
                    </ul>
                </div>

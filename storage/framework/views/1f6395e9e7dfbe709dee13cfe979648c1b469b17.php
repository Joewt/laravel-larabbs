            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li class="<?php echo e(active_class(if_query('tab',null))); ?>"><a href="<?php echo e(route('users.show',$user->id)); ?>">Ta 的话题</a></li>
                        <li class="<?php echo e(active_class(if_query('tab','replies'))); ?>"><a href="<?php echo e(route('users.show',[$user->id,'tab' => 'replies'])); ?>">Ta 的回复</a></li>
                    </ul>
